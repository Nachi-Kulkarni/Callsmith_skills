...
export function outputSchemaText() {
  ...
  return [
    ...
    idMapLine,
    'The receipt `surface` and policy floors must match `voice.answers.json`. `percentile` must be',
    '50, 95, or 99. `policy.basis` must be exactly one of: `callsmith_default`,',
    '`organization_policy`, `legal_review`, `explicit_risk_acceptance`. Regulated domains',
    '(`medical`, `banking`, `collections`, `legal`, `insurance`) additionally require a real',
    '`jurisdiction` and floor-minimum choices.',
    '',
