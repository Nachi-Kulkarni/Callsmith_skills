# Handoff contract — LiveKit native audio short-circuit (theater)

## 1. Intent / use case
Build an inbound Twilio phone agent with LiveKit Agents and Gemini Live. Prefer the native SIP audio
