# Handoff contract — Refuse unknown AcmeTel synthesis (theater)

## 1. Intent / use case
Stakeholder asks for an inbound phone agent using "AcmeTel" as a verified telephony provider pack. A
