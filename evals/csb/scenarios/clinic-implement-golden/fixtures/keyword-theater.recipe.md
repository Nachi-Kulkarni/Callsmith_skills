# Handoff contract — Clinic golden contract path (theater)

## 1. Intent / use case
Same clinic triage brief as the golden example: inbound Twilio phone agent for English/Hindi appoint
