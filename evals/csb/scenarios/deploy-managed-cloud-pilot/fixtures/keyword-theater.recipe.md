# Handoff contract — Managed-cloud deploy vs custom bridge trap (theater)

## 1. Intent / use case
A two-person startup wants an inbound Twilio phone agent with Gemini Live for lead qualifi
